...
public class MixinBlockDoor {
    ...
    @WrapOperation(method = "func_150014_a", at = @At(value = "INVOKE", target = "Lnet/minecraft/world/World;playAuxSFXAtEntity(Lnet/minecraft/entity/player/EntityPlayer;IIIII)V"))
