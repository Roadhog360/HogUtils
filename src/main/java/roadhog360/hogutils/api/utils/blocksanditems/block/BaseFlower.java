...
public abstract class BaseFlower extends BlockFlower implements ISubBlocksBlock {
    ...
    public BaseFlower setHarvestTool(String toolClass, int level) {
    ...
    public BaseFlower setHarvestTool(String toolClass, int level, int meta) {
