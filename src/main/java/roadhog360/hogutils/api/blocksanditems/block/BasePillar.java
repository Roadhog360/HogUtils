...
public abstract class BasePillar extends BlockRotatedPillar implements ISubtypesBlock {
    ...
    public BasePillar(Material material, String... types) {
        super(material);
    ...
    public BasePillar setNames(String name) {
